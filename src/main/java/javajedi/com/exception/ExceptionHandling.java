...
import javajedi.com.exception.domain.*;
import javajedi.com.utility.ResponseHandler;
...
public class ExceptionHandling extends ResponseHandler {
    ...
    private static final String METHOD_IS_NOT_ALLOWED = "This method is not allowed on this request. Please send a '%s' request";
    private static final String INTERNAL_SERVER_ERROR_MSG = "An occur hac occurred while processing the request";
    private static final String INCORRECT_CREDENTIALS = "Username / password incorrect. Please try again";
    private static final String ACCOUNT_DISABLED = "Your account has been disabled. If this is an error, please contact administration";
    private static final String ERROR_PROCESS_FILE = "Error occurred while processing file";
    ...
    public ResponseEntity<HttpResponse> publicationNotFoundException(PublicationNotFoundException exception){
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
    ...
    public ResponseEntity<HttpResponse> methodNotSupportedException(HttpRequestMethodNotSupportedException exception){
        ...
        return createHttpResponse(INTERNAL_SERVER_ERROR, String.format(METHOD_IS_NOT_ALLOWED, supportedMethod));
    }
    ...
    public ResponseEntity<HttpResponse> iOException(IOException exception){
        LOGGER.error(exception.getMessage());
        return createHttpResponse(INTERNAL_SERVER_ERROR, ERROR_PROCESS_FILE);
    }
